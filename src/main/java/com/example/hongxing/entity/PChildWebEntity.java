...
public class PChildWebEntity {
    ...
    private String childWebName;

    private String upperId;

    private String tempLetTeam;

    private String indexPreview;

    private String siteDoMainName;

    private String siteIndexFullPath;

    private String childWebType;
    ...
    private String wmlSupportState;

    private String wmlIndexPreview;

    private Integer wmlPicWidth;

    private Integer wmlPicHeight;

    private Integer wmlPicMaxCharPerPage;

    private Integer maxOnlineUserCount;

    private Integer maxOnlineDate;
