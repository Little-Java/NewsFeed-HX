...
import com.example.hongxing.excel.enums.WriteTypeEnum;
...
public class WriteContextImpl implements WriteContext {
    ...
    private void addMergedRegionToCurrentSheet(ExcelWriteHeadProperty excelWriteHeadProperty, int rowIndex) {
        for (com.example.hongxing.excel.metadata.CellRange cellRangeModel : excelWriteHeadProperty.headCellRangeList()) {
