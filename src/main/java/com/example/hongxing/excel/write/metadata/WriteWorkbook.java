package com.example.hongxing.excel.write.metadata;
...
public class WriteWorkbook extends WriteBasicParameter {
     ...
     */
    @Deprecated
    private com.example.hongxing.excel.event.WriteHandler writeHandler;
    ...
    public com.example.hongxing.excel.event.WriteHandler getWriteHandler() {
        return writeHandler;
    }

    public void setWriteHandler(com.example.hongxing.excel.event.WriteHandler writeHandler) {
