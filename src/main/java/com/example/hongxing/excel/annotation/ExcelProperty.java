package com.example.hongxing.excel.annotation;
...
public @interface ExcelProperty {
    ...
    /**
     *
     * default @see com.example.hongxing.excel.util.TypeUtil if default is not meet you can set format
     *
     * @return Format string
     * @deprecated please use {@link com.example.hongxing.excel.annotation.format.DateTimeFormat}
     */
    @Deprecated
