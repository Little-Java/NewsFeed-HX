package com.example.hongxing.excel.read.metadata;
...
import com.example.hongxing.excel.read.listener.ModelBuildEventListener;
...
public class ReadWorkbook extends ReadBasicParameter {
     ...
     * <p>
     * if true , you can use {@link com.example.hongxing.excel.annotation.ExcelIgnore} ignore a field.
     * <p>
     * if false , you must use {@link com.example.hongxing.excel.annotation.ExcelProperty} to use a filed.
     *
